...
const ATTRACTION_COEFFICIENT = 132e-11; // contols how strongly bugs are pulled toward the center. default 5e-7
...
const BUG_FRICTION_COEFFICIENT = -57e-5; // controls the negative friction of the bugs applying an innate churn without input; default -57e-5
const AIR_FRICTION_COEFFICIENT = 41e-6; // controls how rapidly the bugs slow down; bigger number = slower bugs
...
export default function Bugs(props) {
  ...
  useEffect(() => {
    ...
    const composite = Composite.add(engine.current.world, [getAttractor(), ...getBounds(), ...getBugs()]);
